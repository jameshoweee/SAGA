...
class TestGoodMultivariate:
    """iid Gaussian samples must pass Doornik-Hansen and diagcov."""
...
class TestBadMultivariate:
    """Flawed multivariate distributions should be detected by at least one test."""
    ...
    def test_at_least_one_fails(self, bad_multivariate_vector):
        ...
        detected = dh_fails or dc_fails or coord_fail_rate > 0.1
